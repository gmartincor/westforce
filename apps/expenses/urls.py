...
urlpatterns = [
    ...
    path('type/<str:category_type>/', views.ExpenseListView.as_view(), name='by-type'),
    path('type/<str:category_type>/create/', views.ExpenseCreateView.as_view(), name='create-by-type'),
